...
\sloppy
\title{\vspace{2cm}{\Huge\bfseries\color{mainred} 中性原子量子计算发展历程\\[6pt] 与QuEra技术脉络梳理}\\[16pt]\rule{0.5\textwidth}{1.5pt}\\[12pt]{\large 里德堡阻塞 $\cdot$ 相干搬运 $\cdot$ Transversal STAR $\cdot$ 容错量子计算}\\[8pt]{\footnotesize\color{graytext}数据截止：2026年6月}\\[8pt]{\large 科技委办公室}\\[16pt]{\large\color{graytext}\today}}
\date{}
\begin{document}
