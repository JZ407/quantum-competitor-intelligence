...
\sloppy
\title{\vspace{2cm}{\Huge\bfseries\color{mainred} QuEra Computing\\[6pt] \mbox{}}\\[12pt]{\large 深度研究报告}\\[24pt]\rule{0.5\textwidth}{1.5pt}\\[16pt]{\large 中性原子量子计算 $\cdot$ 容错量子计算 $\cdot$ 哈佛/MIT 血统}\\[8pt]{\footnotesize\color{graytext}数据截止：2026年6月}\\[8pt]{\large 科技委办公室}\\[16pt]{\large\color{graytext}\today}}
\date{}
\begin{document}
