...
\fancyhead[R]{\color{graytext}\small 科技委办公室}
...
\sloppy
\title{\vspace{2cm}{\Huge\bfseries\color{mainred} Algorithmiq\\[6pt] \mbox{}}\\[12pt]{\large 深度研究报告}\\[24pt]\rule{0.5\textwidth}{1.5pt}\\[16pt]{\large 量子计算软件 $\cdot$ 生命科学 $\cdot$ 药物发现}\\[8pt]{\footnotesize\color{graytext}数据截止：2026年6月}\\[8pt]{\large 科技委办公室}\\[16pt]{\large\color{graytext}\today}}
\date{}
\begin{document}
