...
profile = {
    ...
    'key_people': [
        {'name': 'Christian Weedbrook', 'role': 'Founder, CEO & Chairman', 'background': '创始人。理论量子信息背景(UQ博士/MIT/UofT博后)。从2016年$2.5M种子轮到2026年$3.1B上市的自始至终领导者。'},
        {'name': 'Zachary Vernon', 'role': 'CTO / Head of Hardware', 'background': '硬件负责人兼首席技术官。主导Aurora——全球首台模块化通用光子量子计算机——的设计与建造(Nature 2025)。Xanadu硬件路线的技术核心。'},
        {'name': 'Nathan Killoran', 'role': 'Head of Software & Algorithms', 'background': 'PennyLane首席开发者。主导Xanadu的软件生态系统建设，使PennyLane成为全球量子开发者使用率第一(47%)的编程平台。'},
        {'name': 'Juan Miguel Arrazola', 'role': 'Head of Algorithms', 'background': '算法部门负责人，专注于量子机器学习与混合量子-经典算法研发。'},
        {'name': 'Rafal Janik', 'role': 'COO', 'background': '首席运营官，负责公司日常运营和规模化扩张。'},
        {'name': 'Michael Trzupek', 'role': 'CFO', 'background': '2026年1月加入。前Core Scientific CFO，微软/Intel/Imagination Technologies财务领导经验。为Xanadu上市做准备的关键任命。'},
        {'name': 'Natalie Wilmore', 'role': 'CLO', 'background': '2026年1月加入。前Pagaya Technologies VP/Deputy GC，Skillz/IBM法务经验。上市合规和知识产权战略负责人。'},
        {'name': 'Rebecca Laramee', 'role': 'CPO', 'background': '首席人才官，负责260人团队的人才战略和扩张(计划再招50-100人)。'},
    ],
